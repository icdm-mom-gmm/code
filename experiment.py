...
'''
Synthetic Experiment ICDM
'''
def icdm_synth_exp(ns, nmb_models, dest_dir, dims, ts, alpha0s, sample_alphas, sample_mus, sample_sigmas, sigma_eps= 1e-3, seed = None, save_intermediate=False, *args, **kwargs):
    '''
...
if __name__ == "__main__":
    ...
    df_result = icdm_synth_exp(**params)
    df_result.head()